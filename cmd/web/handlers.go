...
import (
	...
	"github.com/mfroeh/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	// Limit the qurest body size to 4096 bytes
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	redirect := app.sessionManager.PopString(r.Context(), "fromURL")
	if redirect == "" {
		redirect = "/"
	}
...
func (app *application) accountPasswordUpdate(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, http.StatusOK, "changePassword.tmpl", data)
}
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		data := app.newTemplateData(r)
		data.Form = form
		app.render(w, r, http.StatusUnprocessableEntity, "changePassword.tmpl", data)
		return
	}
